...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] tiposDeArea = new String[100]; // Array para armazenar o tipo de cada área
        ...
        while (true) {
            ...
            if (areaJardim < 100) {
                ...
                areasPequenas++;
                tiposDeArea[indice - 1] = tamanho[0];  // Armazenando o tipo de área
            }else {
                JOptionPane.showMessageDialog(null, "Area do Jardim: "+areaJardim+"\nTamanho: "+tamanho[1]);
                areasGrandes++;
        ...
        // Exibindo o gráfico de barras com a quantidade de serviços contratados
